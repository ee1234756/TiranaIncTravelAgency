...
<head>   
<meta charset="utf-8">   
<title>Tirana Inc. Travel Agency</title>
...
<h3 style="font-weight: bold; color: white;">Packages Info</h3>
</div>
...
<table id="myTable" class="table table-bordered table-striped table-hover table-condensed" >  
         ...
         <thead>
                        <th style="font-weight: bold; color: white;">Reference ID </th>
                        <th style="font-weight: bold; color: white;">Location</th>
                        <th style="font-weight: bold; color: white;">Destination Date</th>
                        <th style="font-weight: bold; color: white;">Arrival Date</th>
                        <th style="font-weight: bold; color: white;">Transport</th>
                        <th>Price in €</th>
                    </thead>
                    <tbody>
